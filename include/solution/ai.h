...
#ifndef EXTERNALSORTINGLAB1_AI_H
#define EXTERNALSORTINGLAB1_AI_H

#include "common.h"

class AiSolution final : public Solution {
public:
    explicit AiSolution(const std::vector<std::unique_ptr<FileManager> > &first_bucket,
...
#endif //EXTERNALSORTINGLAB1_AI_H
